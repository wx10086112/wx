...
export const dynamicRoutes = [
  ...
  // ========== 数据分析 ==========
  {
    ...
    children: [
      ...
      { path: 'sales', component: () => import('@/views/data-analysis/sales'), name: 'SalesStats', meta: { title: '销售统计' } },
      { path: 'order-stats', component: () => import('@/views/data-analysis/order-stats'), name: 'OrderStats', meta: { title: '订单统计' } }
    ]
  },
  // ========== 系统管理 ==========
  {
