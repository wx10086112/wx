  ...
  <div class="app-container">
    <el-card>
      ...
      <el-table v-loading="loading" :data="tableList" border>
        ...
        <el-table-column label="异常原因" prop="issue" min-width="180" show-overflow-tooltip />
    ...
    <el-dialog title="异常订单处理" :visible.sync="processDialogVisible" width="500px">
      <template v-if="currentRow">
        <el-descriptions :column="1" border size="small">
          ...
          <el-descriptions-item label="订单金额">¥{{ currentRow.amount.toFixed(2) }}</el-descriptions-item>
        </el-descriptions>
