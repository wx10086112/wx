  ...
  <div class="app-container">
    ...
    <el-dialog title="提现详情" :visible.sync="detailDialogVisible" width="550px">
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item v-if="detailRow.completeTime" label="完成时间">{{ detailRow.completeTime }}</el-descriptions-item>
    ...
    <el-dialog title="拒绝提现" :visible.sync="rejectDialogVisible" width="450px" :close-on-click-modal="false">
      <el-form label-width="80px">
        <el-form-item label="商家名称">
          <span>{{ rejectRow.merchantName }}</span>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handlePass(row) {
      this.$confirm(`确认通过 ${row.merchantName} 的提现申请（¥${row.amount.toLocaleString()}）？`, '确认通过', {
