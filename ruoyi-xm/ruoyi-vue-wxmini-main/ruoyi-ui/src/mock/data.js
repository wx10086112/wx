...
export const merchantList = [
  { id: 1, name: '鲜味火锅城', contact: '张三', phone: '13800138001', level: 'A', status: 1, createTime: '2026-01-15', products: 28, monthlySales: 52800 },
  { id: 2, name: '日式匠心料理', contact: '李四', phone: '13800138002', level: 'A', status: 1, createTime: '2026-02-03', products: 15, monthlySales: 41600 },
  { id: 3, name: '果鲜优选', contact: '王五', phone: '13800138003', level: 'B', status: 1, createTime: '2026-02-20', products: 42, monthlySales: 38200 },
  { id: 4, name: '悦健健身', contact: '赵六', phone: '13800138004', level: 'B', status: 1, createTime: '2026-03-01', products: 8, monthlySales: 29800 },
  { id: 5, name: '美颜美容馆', contact: '钱七', phone: '13800138005', level: 'C', status: 2, createTime: '2026-03-10', products: 12, monthlySales: 25400 },
  { id: 6, name: '川味小馆', contact: '孙八', phone: '13800138006', level: 'C', status: 1, createTime: '2026-03-18', products: 20, monthlySales: 22100 },
  { id: 7, name: '甜心烘焙坊', contact: '周九', phone: '13800138007', level: 'B', status: 0, createTime: '2026-04-02', products: 35, monthlySales: 19800 },
  { id: 8, name: '绿叶蔬果店', contact: '吴十', phone: '13800138008', level: 'C', status: 1, createTime: '2026-04-15', products: 56, monthlySales: 17500 }
]

export const merchantLevels = [
  { id: 1, name: 'S级', commission: 5, description: '顶级商家，佣金率最低', merchantCount: 8 },
  { id: 2, name: 'A级', commission: 8, description: '优质商家，佣金率优惠', merchantCount: 25 },
  { id: 3, name: 'B级', commission: 10, description: '普通商家，标准佣金率', merchantCount: 68 },
  { id: 4, name: 'C级', commission: 15, description: '新入驻商家', merchantCount: 55 }
]
...
export const auditList = [
  { id: 1, merchantId: 5, name: '美颜美容馆', contact: '钱七', phone: '13800138005', level: 'C', applyTime: '2026-03-10', status: 0, reason: '' },
  { id: 2, merchantId: 9, name: '潮汕牛肉火锅', contact: '林老板', phone: '13800138009', level: 'C', applyTime: '2026-05-08', status: 0, reason: '' },
  { id: 3, merchantId: 10, name: '星空咖啡馆', contact: '陈店长', phone: '13800138010', level: 'C', applyTime: '2026-05-09', status: 0, reason: '' },
  { id: 4, merchantId: 6, name: '川味小馆', contact: '孙八', phone: '13800138006', level: 'C', applyTime: '2026-03-18', status: 1, reason: '' },
  { id: 5, merchantId: 3, name: '果鲜优选', contact: '王五', phone: '13800138003', level: 'B', applyTime: '2026-02-20', status: 1, reason: '' },
  { id: 6, merchantId: 11, name: '花间集花艺', contact: '花花', phone: '13800138011', level: 'C', applyTime: '2026-05-01', status: 2, reason: '资质不全，请补充营业执照' }
]
...
export const operationLogList = [
  ...
  { id: 3, operator: 'admin', module: '商家管理', operation: '修改商家等级', method: 'MerchantController.updateLevel', ip: '192.168.1.100', time: '2026-05-09 11:30:00', status: 0, costTime: 45 },
